...
final class JMTimelineCompositeAudioBlock: JMTimelineBlock {
    ...
    init(type: JMTimelineCompositePlayableItem) {
        ...
        let resumeIcon = UIImage(named: "player_resume", in: Bundle.module, compatibleWith: nil)?.withRenderingMode(.alwaysTemplate)
        ...
        let pauseIcon = UIImage(named: "player_pause", in: Bundle.module, compatibleWith: nil)?.withRenderingMode(.alwaysTemplate)
